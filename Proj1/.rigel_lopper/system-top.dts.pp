# 1 "C:\\Users\\beful\\Downloads\\WSU-SPRING-26\\EE234\\Proj1\\blackboard-platform\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\Users\\beful\\Downloads\\WSU-SPRING-26\\EE234\\Proj1\\blackboard-platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\Users\\beful\\Downloads\\WSU-SPRING-26\\EE234\\Proj1\\blackboard-platform\\hw\\sdt\\zynq-7000.dtsi" 1
# 10 "C:\\Users\\beful\\Downloads\\WSU-SPRING-26\\EE234\\Proj1\\blackboard-platform\\hw\\sdt\\zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "C:\\Users\\beful\\Downloads\\WSU-SPRING-26\\EE234\\Proj1\\blackboard-platform\\hw\\sdt\\system-top.dts" 2
# 1 "C:\\Users\\beful\\Downloads\\WSU-SPRING-26\\EE234\\Proj1\\blackboard-platform\\hw\\sdt\\pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  ...
  clk_wiz: clk_wiz@43c40000 {
   ...
   xlnx,component-name = "system_clk_wiz_0";
  };
  esp32_uart1: serial@42c00000 {
   interrupts = < 0 32 1 >;
  ...
  pdm_audio: pdm_audio@43c20000 {
   ...
   xlnx,speaker-r-en;
   interrupts = < 0 29 1 0 30 1 0 31 1 >;
   interrupt-parent = <&intc>;
   ...
   xlnx,pcmresetcyclesparam = <2112>;
   interrupt-names = "spkLIntr" , "spkRIntr" , "micIntr";
   xlnx,name = "pdm_audio";
  };
  pwm_servo_4: timer@42800000 {
   interrupts = < 0 59 4 >;
  ...
  xadc_wiz: xadc_wiz@43c50000 {
   ...
   xlnx,component-name = "system_xadc_wiz_0";
   xlnx,external-muxaddr-enable = <0>;
  };
 };
};
# 4 "C:\\Users\\beful\\Downloads\\WSU-SPRING-26\\EE234\\Proj1\\blackboard-platform\\hw\\sdt\\system-top.dts" 2
# 1 "C:\\Users\\beful\\Downloads\\WSU-SPRING-26\\EE234\\Proj1\\blackboard-platform\\hw\\sdt\\pcw.dtsi" 1
 &ps7_cortexa9_0 {
 ...
 &amba {
  processing_system7_0: processing_system7@0 {
   ...
   xlnx,pcw-act-fpga1-peripheral-freqmhz = <0x2ef33b>;
   ...
   xlnx,pcw-uiparam-ddr-speed-bin = "DDR3_1600K";
   ...
   xlnx,pcw-spi0-peripheral-enable = <1>;
   ...
   xlnx,pcw-spi0-grp-ss1-enable = <1>;
   ...
   xlnx,pcw-spi0-grp-ss0-enable = <1>;
   xlnx,fclk-clk0-buf;
   ...
   xlnx,pcw-fclk1-peripheral-divisor0 = <25>;
   xlnx,pcw-fclk1-peripheral-divisor1 = <13>;
   ...
   xlnx,pcw-gpio-emio-gpio-width = <24>;
   ...
   xlnx,pcw-num-f2p-intr-inputs = <16>;
   ...
   xlnx,pcw-uiparam-ddr-t-rcd = <0xd1cef0>;
   ...
   xlnx,pcw-uiparam-ddr-t-rp = <0xd1cef0>;
   ...
   xlnx,pcw-fpga1-peripheral-freqmhz = <0x2ee000>;
   ...
   xlnx,pcw-en-uart0 = <1>;
   xlnx,pcw-i2c1-peripheral-enable = <1>;
   xlnx,pcw-en-uart1 = <1>;
...
# 5 "C:\\Users\\beful\\Downloads\\WSU-SPRING-26\\EE234\\Proj1\\blackboard-platform\\hw\\sdt\\system-top.dts" 2
/ {
 device_id = "7z007s";
 family = "Zynq";
 speed_grade = "1";
